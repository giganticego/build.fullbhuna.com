var capslock = {
  ...
  show_warning: function(targ) { 
    if (!targ.warning) {
	  ...
	  targContainer = targ.parentNode; 
      targ.warning.src = "/login/images/caps_lock_warning.png";
      targ.warning.style.position = "absolute";
      targ.warning.style.top = (targContainer.offsetTop - 90) + "px";
      targ.warning.style.left = (targContainer.offsetLeft + targContainer.offsetWidth - 25) + "px";
...
"progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/login/images/caps_lock_warning.png',sizingMethod='scale')";
      }
      targContainer.appendChild(targ.warning);
    }
  },
