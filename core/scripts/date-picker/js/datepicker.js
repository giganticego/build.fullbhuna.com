...
function datePicker(options) {
        ...
        o.create = function() {
                ...
                if(o.staticPos) {
                        ...
                        if(o.splitDate) {
                                var mmN = document.getElementById('mm-'+o.id);
                                var ddN = document.getElementById('dd-'+o.id);
        ...
        o.returnFormattedDate = function() {
                ...
                if(!(o.disableDays[weekDay] || String(yyyy)+m+d in disabledDates)) {
                        ...
                        if(o.splitDate) {
                                var ddE = document.getElementById('dd-'+o.id);
                                var mmE = document.getElementById('mm-'+o.id);
								// ADDED BY ME TO ADD YEAR FUNCTION
								var yyE = document.getElementById('yy-'+o.id);
								...
								if(yyE.tagName.toLowerCase() == "input") yyE.value = yyyy;
                                else {
                                        o.setSelectIndex(yyE, yyyy);
                ...
                for(var i=0, inp; inp = inputs[i]; i++) {
                        if(inp.className && (inp.className.search(regExp6) != -1 || inp.className.search(/split-date/) != -1) && ((inp.tagName.toLowerCase() == "input" && (inp.type == "text" || inp.type == "hidden")) || inp.tagName.toLowerCase() == "select")) {
                                ...
                                if(inp.className.search(/split-date/) != -1) {
                                        if(document.getElementById('dd-'+inp.id) && document.getElementById('mm-'+inp.id) && document.getElementById('dd-'+inp.id).tagName.search(/input|select/i) != -1 && document.getElementById('mm-'+inp.id).tagName.search(/input|select/i) != -1) {
                                                options.splitDate = 1;
                                        };
                                };
